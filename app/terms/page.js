    ...
    <div className="mx-auto max-w-3xl grid gap-6">
      ...
      <div className="card p-6 leading-9 text-slate-300">
        <ol className="grid gap-3 pr-5 list-decimal">
          <li>المصادر الخاصة (الأحكام، المرفقات، ملفات الشركة) سرية ولا يجوز نشرها أو مشاركتها خارج المنصة.</li>
          <li>صلاحية «المطوّر» تتيح الاطلاع على كل المحتوى بمستوياته (خاص/للشركة/عام) لأغراض التطوير والإدارة فقط.</li>
